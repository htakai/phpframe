 ...
 * C:\xampp\vendor\bin>phpunit ../../framework3/test/Dispatcher6Testとしてテスト.
 */
...
class Dispatcher6Test extends TestCase
{
     ...
     * @expectedExceptionMessage plevel:2 setting mistake!
     */
    public function plevelチェックによって例外処理が発生する()
    {
        //controller-->index, action-->indexのつもり
        $this->ret = $this->dispatcher->dispatch('/news3/',2);
